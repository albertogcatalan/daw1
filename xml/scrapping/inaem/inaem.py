...
class Inaem(object):
    ...
    def listado_manana_tarde(self):
        ...
        for curso in self._lista_cursos:
            if "Tarde" in curso.inicio:
                tardes += 1
            elif "Mañana" in curso.inicio:
                manana += 1
        
        print "Cursos de Mañana: "+str(manana)+"\nCursos de Tarde: "+str(tardes)
    ...
    def generar_html(self):
        '''Genera HTML con la información de los nombres de cursos de informática,
        la población y el mes de inicio'''
        f = open('inaem.html', 'w')
        ...
        f.write('<tr bgcolor="#FE2E2E"><td>Nombre del Curso</td><td>Población</td><td>Mes de inicio</td></tr>')
        for curso in self._lista_cursos:
            f.write('<tr><td align="center">'+str(curso.nombre)+'</td><td align="center">'+str(curso.localidad)+'</td><td align="center">'+str(curso.inicio)+'</td></tr>')
...
if __name__ == '__main__':
    ...
    print "*" * 40
    print "¿Cuántos cursos hay de mañana y cuántos de tarde?"
    print "*" * 40
    inaem.listado_manana_tarde()
    print "*" * 40
    print "¿Cuántos hay en cada localidad?"
    print "*" * 40
